...
class MTKFrame extends JFrame {
  ...
  private ArrayList<JButton> carButtons = new ArrayList<JButton>();
  private JPanel carPanel;
  private int activeTopBtn = 1;
  private int activeCarBtn = 1;
  private NewCarDialog newCarDialog = null;
  private NewRowDialog newRowDialog = null;
  private DbHandler dbHandler;
  private JTable table = null;
  private File propertiesFile;
  private Properties settings;
  private JLabel resultLbl;
  private TableRowSorter<PartsTableModel> sorterPart;
  private TableRowSorter<ToTableModel> sorterTo;
  private JTextField fromDate;
  private JTextField toDate;
  DeleteCellRenderer deleteCellRenderer = new DeleteCellRenderer();
  DeleteCellEditor deleteCellEditor = new DeleteCellEditor();
  
  private static Logger logger = Logger.getLogger("ru.bahusdivus.mtkauto");
  ...
  JButton makeCarBtn(String label, int id) {
  ...
  void setTable() {
    ...
    if (activeTopBtn != 4) {
      ...
      if (mdlRowCount > 0) {
        ...
        //Setting sorter
        sorterPart = new TableRowSorter<PartsTableModel>(newTM);
        table.setRowSorter(sorterPart);
        ...
        System.out.println("Emty table set.");
      }
    }else {
      ...
      if (mdlRowCount > 0) {
        ...
        table.moveColumn(0, table.getColumnCount() - 1);
        sorterTo = new TableRowSorter<ToTableModel>(newTM);
        table.setRowSorter(sorterTo);
        TableColumnModel tcm = table.getColumnModel();
        tcm.getColumn(table.getColumnCount() - 1).setCellRenderer(deleteCellRenderer);
        tcm.getColumn(table.getColumnCount() - 1).setCellEditor(deleteCellEditor);
        tcm.removeColumn( tcm.getColumn(0) );
  ...
  class PartsTableModel extends AbstractTableModel {
    ...
    public PartsTableModel(List<Part> list) {
      data = list;
    }
  ...
  class ToTableModel extends AbstractTableModel {
    ...
    public ToTableModel(List<TO> list) {
      data = list;
    }
  ...
  private class NewCar implements ActionListener {
    public void actionPerformed(ActionEvent event) {
      ...
      if (newCarDialog.showDialog(MTKFrame.this)) {
        ...
        makeCarPanel();
        System.out.println("Car number = " + newCarDialog.getNumber());
      }
    }
  }
