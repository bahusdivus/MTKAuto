...
class MtkJFrame extends JFrame {
    ...
    MtkJFrame() {
        try {
            ...
            delCarBtn.addActionListener(event -> {
                    dbHandler.deleteCar(carPanel.getActiveCarBtn());
    ...
    private void setTable() {
        ...
        if (activeTopBtn != 4) {
            PartsTableModel newTM = new PartsTableModel(dbHandler.getParts(carPanel.getActiveCarBtn(), activeTopBtn));
            ...
            ToTableModel newTM = new ToTableModel(dbHandler.getTOByCarId(carPanel.getActiveCarBtn()));
            int mdlRowCount = newTM.getRowCount();
            if (mdlRowCount > 0) {
                if (table == null) {
                    table = new JTable(newTM);
